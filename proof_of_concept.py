...
if example:
    print("✓ Generated Complete Training Example:")
    ...
    print("✗ Failed - example rejected (quality too low)")
...
print(f"\n✓ Generated {len(engine2.training_data)} accepted examples")
...
print("  ✓ FREE APIs work (Groq, SambaNova, Gemini)")
print("  ✓ Questions generated automatically")
print("  ✓ Answers generated automatically")
print("  ✓ Quality validation works")
print("  ✓ Complete training examples created")
print("  ✓ Continuous generation works")
